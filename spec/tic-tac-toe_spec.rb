...
describe Board do
  let(:board_obj){Board.new(['X', 'O', 'X', 'O', 'X', 'O', 'X', '8', '9'])}
...
describe Board do
  let(:board_obj){Board.new(['X', '2', '3', '4', '5', '6', '6', '8', '9'])}
    it "Returns True when there is a winner otherwise it returns False" do
...
describe Board do
  let(:board_obj){Board.new(['X', 'O', 'X', 'X', 'O', 'X', 'O', 'X', 'O'])}
...
describe Board do
  let(:board_obj){Board.new(['X', 'O', 'X', 'X', 'O', 'X', 'O', 'X', '9'])}
    it "Returns true when the array has no integers left on it" do
